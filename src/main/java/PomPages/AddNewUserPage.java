...
//Declaration
	...
	public void deleteCourse(WebDriverUtility web, String courseName, String deletePath, WebElement deleteButton) {
	web.convertPathToWebElement(deletePath, courseName).click();
	deleteButton.click();
}
	public String getSuccessMessage(WebElement SuccessMessage) {
